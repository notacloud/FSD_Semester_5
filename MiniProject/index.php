...
<body >
    <div class="container" >
        <div class="row">
            ...
            <p align='center' style="color:black;font-family:'Menlo';font-weight:bold;padding-bottom:60px;">Delivering the way you want</p>
                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <input style="padding-left:15px" type="submit" name="submit" class="btn btn-primary" value="  Sign In" />
                        <button onclick="window.location.href='resetpswd.php'" class="btn btn-danger" style="cursor:pointer">Reset Password</button>
                    </div>
                    <p style="color: black;">Don't have an account?<a href="register.php" style="color:red;">Register here</a>.</p>
                    <p style="color: black;">Are you admin?<a href="admin/adminlogin.php" style="color:red;">Login here</a>.</p>
                </form>
            </div>
        </div>
    </div>
